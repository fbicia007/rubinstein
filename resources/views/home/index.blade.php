...
@section('mainContent')
    ...
    <!-- ======================= Main Content ======================= -->
    <div id="content-area" class="main-content"><div class="row">
            <div class="home-content pad-top-40 pad-btm-10">
                ...
                <div class="post-13 page type-page status-publish hentry" id="post-13">
                    ...
                    <div class="clearfix">
                        <div class="small-12 large-10 columns large-centered text-center">
                            <h1 class="page-title">量身打造具有国际化水准的音乐课程</h1>
                            <p style="text-align: center;">安东·鲁宾斯坦国际音乐学院致力于为有才华的年轻音乐家提供个性化的学习机会。 我们提供广泛的学习选择：包含全日制学习和具有国家认证的研究生课程以及私人课程和大师班。 我们的目标是在多样化和个性化的氛围中提供具有国际竞争力的专业课程.</p>
                            ...
                            <a href="{{url('infos')}}" class="page-btn ">学院简介</a>
                        </div>
                    </div>
